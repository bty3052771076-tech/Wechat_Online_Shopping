const { collectChildMethodCalls } = require('../../../../../../services/_utils/form-helpers');
...
Component({
  ...
  methods: {
    setActive(activeKey, isChildrenChange) {
      ...
      stack.push(...collectChildMethodCalls(children, preTopRightRadiusItemIndexs, 'setTopRightRadius', false));
      stack.push(...collectChildMethodCalls(children, preBottomRightRadiusItemIndexs, 'setBottomRightRadius', false));
      stack.push(...collectChildMethodCalls(children, this.topRightRadiusItemIndexs, 'setTopRightRadius', true));
      stack.push(...collectChildMethodCalls(children, this.bottomRightRadiusItemIndexs, 'setBottomRightRadius', true));
